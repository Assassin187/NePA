...
def __getattr__(name: str):
    ...
    if name in {"classify_migration", "project_plan_state", "project_file_ledger", "validate_revision_ledger", "validate_file_ledger", "validate_plan_successor", "successor_pointer", "build_revision_entry", "append_revision_entry", "append_verification_committed", "latest_activation", "build_event_entry", "append_epoch_materialized"}:
        from .plan_revision import append_epoch_materialized, append_revision_entry, append_verification_committed, build_event_entry, build_revision_entry, classify_migration, latest_activation, project_file_ledger, project_plan_state, successor_pointer, validate_file_ledger, validate_plan_successor, validate_revision_ledger
        return {"classify_migration": classify_migration, "project_plan_state": project_plan_state, "project_file_ledger": project_file_ledger, "validate_revision_ledger": validate_revision_ledger, "validate_file_ledger": validate_file_ledger, "validate_plan_successor": validate_plan_successor, "successor_pointer": successor_pointer, "build_revision_entry": build_revision_entry, "append_revision_entry": append_revision_entry, "append_verification_committed": append_verification_committed, "latest_activation": latest_activation, "build_event_entry": build_event_entry, "append_epoch_materialized": append_epoch_materialized}[name]
    if name in {"initialize_plan_state", "plan_state_snapshot_lint", "project_state_transition", "validate_state_transition", "execution_state_lint"}:
        from .plan_state import execution_state_lint, initialize_plan_state, plan_state_snapshot_lint, project_state_transition, validate_state_transition
        return {
