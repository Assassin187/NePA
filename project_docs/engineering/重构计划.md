...
| 365 obsolete source/schema/test/fixture paths | Exact paths and replacement coverage in 重构删除台账.json; no remaining production imports; baseline recovery |
...
../experiments/会话上下文失效分析.md for the exact runs and transcript audit.
...
See ../experiments/会话延迟分析.md:147.36 wall minutes including18.58-minute recharge/
...
40.4% and41.5% less wall time. See ../experiments/会话延迟分析.md for measured categories,
