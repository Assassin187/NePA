...
def test_schema_contract_audit():
    expected = {
        ...
        "delivery-blueprint.schema.json",
        "task-shard.schema.json",
        "plan-draft-ir.schema.json",
        "plan.schema.json",
        "link-report.schema.json",
        "plan-state.schema.json",
        "plan-event.schema.json",
        ...
        "calibration-baseline-neutrality.schema.json",
        ...
        "revision-gate-result.schema.json",
        "revision-rehearsal.schema.json",
        ...
        "coding-response.schema.json",
            ...
            "s6-validation.schema.json",
        "task-evidence.schema.json",
        "verification-pending.schema.json",
        "s6-receipt.schema.json",
        "lease-authorization.schema.json",
            "joint-evidence.schema.json",
