...
def _screened(initial_failures):
    ...
    return {"status": "complete", "metrics": {"schema_after_format_repair_rate": 1.0, "p1": 1.0, "p2": 1.0, "arch_semantic_first_pass_rate": 1.0}, "usage": {"truncated": 0, "cost_usd": 0}, "model_identity": {"provider": "provider", "model": "model", "versions": ["version"], "parameter_support": {}}, "trial_metrics": [{"p2": True, "gates": copy.deepcopy(gates)}, {"p2": True, "gates": copy.deepcopy(gates)}, {"p2": True, "gates": copy.deepcopy(gates)}]}
